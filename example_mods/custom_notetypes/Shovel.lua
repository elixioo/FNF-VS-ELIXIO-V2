function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		...
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'Shovel' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'SHOVELNOTE_assets'); --Change texture
