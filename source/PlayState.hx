...
case 'mall': //Week 5 - Cocoa, Eggnog
			...
			case 'funky': //Week 7
				var bg:BGSprite = new BGSprite('funky', -600, -200, 0.9, 0.9);
				add(bg);

			case 'funkybf': //Week 8
				var bg:BGSprite = new BGSprite('funkybf', -600, -200, 0.9, 0.9);
				add(bg);
		...
		timeTxt.setFormat(Paths.font("biko.otf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		scoreTxt.setFormat(Paths.font("biko.otf"), 20, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		botplayTxt.setFormat(Paths.font("biko.otf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
			...
			switch (daSong)
			{
				...
				case 'senpai' | 'roses' | 'thorns':
					...
					schoolIntro(doof);
					    ...
					    case 'unravel':
     						startVideo('cutsceneone');

						 case 'chamoy':
     						startVideo('cutscenetwo');

						 case 'killer-fish':
     						startVideo('cutscenethree');
				default:
					startCountdown();
			}
			seenCutscene = true;
