...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color
		['Vs Elixio Team'],
		['Elixio',		'elixio',		'Composer, Animator, BG Artist, Charting',					'https://www.youtube.com/channel/UC4CNlbDAFknwXwmRpBHG9sQ',	0xFFFFDD33],
		['n0mdomestudios',			'nom',		'Elixio Sprites',				'https://www.fiverr.com/n0mdomestudios/draw-your-character-in-a-friday-night-funkin-style?source=order_page_summary_gig_link_title&funnel=dce5ef628f06d27c8676096b212edc20',		0xFFC30085],
		[''],
		['Psych Engine Team'],
